...
import logging
# os.environ['WANDB_API_KEY'] = 'a40f028907ed55e6d4b893adc1b7b9abd5c5e6c0'
...
if __name__ == '__main__':
    ...
    for run_id, seed, split_index in zip(*run_loop_settings(cfg, args)):
        ...
        print(f"=== RUN ID: {run_id}, SEED: {seed}, SPLIT: {split_index} ===")
        ...
        print("Data loaders created.",loaders)
