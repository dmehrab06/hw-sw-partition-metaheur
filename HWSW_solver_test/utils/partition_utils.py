...
class ScheduleConstPartitionSolver:
    ...
    def load_pickle_graph(self, graph_file):
        ...
        # JK edited to remove TaskGraph object
        self.populate_graph_with_attributes(data.graph, data.hardware_area, data.hardware_costs, data.software_costs, data.communication_costs)
    ...
    # JK rewritten to use a raw networkx graph and feature vectors, avoiding the custom TaskGraph object
    #
