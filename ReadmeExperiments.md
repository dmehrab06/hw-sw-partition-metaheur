...
nohup ./BatchExperiments2/run_squeezenet_area_sweep_10seed.sh > ./BatchExperiments2/others_area_sweep_apr_10.log 2>&1 &



CUDA_VISIBLE_DEVICES=0 \
DATASETS_CSV=paper_fig3_11node,squeeze_net_tosa \
PAPER_FIG3_EPOCHS=50 \
SQUEEZENET_TOSA_EPOCHS=100 \
SEEDS_CSV=42 \
./BatchExperiments/Ablation/run_diff_gnn_order_lssp_trace.sh

CUDA_VISIBLE_DEVICES=0 \
DATASETS_CSV=squeeze_net_tosa \
SQUEEZENET_TOSA_EPOCHS=1000 \
SEEDS_CSV=42 \
./BatchExperiments/Ablation/run_diff_gnn_order_lssp_trace.sh


CUDA_VISIBLE_DEVICES=0 DATASETS_CSV=paper_fig3_11node PAPER_FIG3_EPOCHS=150 SEEDS_CSV=42 ./BatchExperiments/Ablation/run_diff_gnn_order_lssp_trace.sh
